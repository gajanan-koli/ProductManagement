...
namespace glob.ProductManager.Migrations
{
    ...
    [Migration("20211001102742_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("glob.ProductManager.Products.Brand", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("glob.ProductManager.Products.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("glob.ProductManager.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("glob.ProductManager.Products.Product", b =>
                {
                    b.HasOne("glob.ProductManager.Products.Brand", "Brand")
                        .WithMany("Product")
                        .HasForeignKey("BrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("glob.ProductManager.Products.Category", "Category")
                        .WithMany("Product")
